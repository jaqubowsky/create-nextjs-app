        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-20 items-center">
          ...
          <div className="relative lg:ml-8">
            <div className="relative mx-auto w-full max-w-lg">
              ...
              <div className="absolute -top-6 -right-6 w-24 h-24 bg-gradient-to-br from-primary/30 to-accent/30 rounded-full opacity-60 animate-pulse blur-sm" />
              <div className="absolute -bottom-8 -left-8 w-20 h-20 bg-gradient-to-br from-accent/30 to-primary/30 rounded-full opacity-60 animate-pulse delay-1000 blur-sm" />
              <div className="absolute top-1/2 -right-4 w-16 h-16 bg-primary/20 rounded-full opacity-40 animate-pulse delay-500 blur-sm" />
            </div>
          </div>
        </div>
      </div>
